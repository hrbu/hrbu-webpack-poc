...
With the new approach any development supporting tool is managed as a dependency within the `package.json` and can therefore updated by a simple `npm update` on the commandline.